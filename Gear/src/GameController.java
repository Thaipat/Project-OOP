...
//                state = STATE.GAME;
            ...
            randomNum = ThreadLocalRandom.current().nextInt(6, 6 + 1);
            this.random = randomNum;
//            currentPosition += randomNum;
            currentPosition1 %= 20;
            currentPosition2 %= 20;
            System.out.println("=======================CountRound========================");
            System.out.println("CountRound : "+CountRound);
            System.out.println("=========================================================");
            //<------------------------------------------Event Controll-------------------------------------------------------------------=>
            if(state == true) {
                if (isPlayer1 == true) {
        ...
        if (enmemypokemon.getHP() < 30 && warring == 0 && ((!isPlayer1 && playerA.getPokeball().getAmount() > 0) || (isPlayer1 && playerB.getPokeball().getAmount() > 0))) {
            ...
            if(response == 0) {
                ...
                if (isPlayer1 == false && playerA.getPokeball().getAmount() > 0) {
                    ...
                    gameView.getMapView().getPokeballLabel1().setText("x"+playerA.getPokeball().getAmount());
                    System.out.println("===================================");
                    System.out.println("Player'A Bag");
                    System.out.println("Pokeball : "+playerA.getPokeball().getAmount());
                    System.out.println("Potion : "+playerA.getPotion().getAmount());
                    System.out.println("PokemonSize : "+playerA.getPokemons().size());
                    System.out.println("===================================");
                    //<------------------------------------------------------------------------>
                    ...
                    gameView.getMapView().getPokeballLabel2().setText("x"+playerB.getPokeball().getAmount());
                    System.out.println("===================================");
                    System.out.println("Player'B Bag");
                    System.out.println("Pokeball : "+playerB.getPokeball().getAmount());
                    System.out.println("Potion : "+playerB.getPotion().getAmount());
                    System.out.println("===================================");
                    //<------------------------------------------------------------------------>
...
//            }
        ...
        if(CountRound  >= 10 && playerFight == true){
